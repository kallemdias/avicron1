package com.mellak.tools.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.mellak.tools.service.EmailAlreadyUsedException ||
            ex instanceof com.mellak.tools.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof com.mellak.tools.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.mellak.tools");
    }
}
